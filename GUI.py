...
print("The R2 value for Training Set is :",r2_score(pred_train,y_train))

def user_input_features():
    D=st.sidebar.number_input("D",value=1200.000,format="%.3f")
    LD =st.sidebar.number_input("L/D",value=6.600,format="%.3f")   
